...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 m-auto">
            <form enctype="multipart/form-data" method="POST" action="<?php echo e(route('categories.saveedit')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <label>Image</label>
                <input class="form-control mb-4" type="file" name="cate_image">
...
unset($__errorArgs, $__bag); ?>
                ...
                <input class="form-control mb-4" type="text" name="parent_id" value="<?php echo e($item->parent_id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\elshafey\resources\views/categories/edit.blade.php ENDPATH**/ ?>