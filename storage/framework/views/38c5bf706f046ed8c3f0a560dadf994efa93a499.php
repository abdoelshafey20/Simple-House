    ...
    <div class="row">
        <div class="col-md-8 m-auto ">
            <h3 class="text-center">Create New Product</h3>
                <form action="<?php echo e(route('products.savenew')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\elshafey\resources\views/products/create.blade.php ENDPATH**/ ?>