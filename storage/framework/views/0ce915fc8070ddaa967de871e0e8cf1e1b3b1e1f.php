    ...
    <div class="row">
        <div class="col-md-8 m-auto ">
            <h3 class="text-center">Create New Comment</h3>
                <form action="<?php echo e(route('comments.savenew')); ?>" method="post" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="submit" class="btn btn-success btn-block"value="Create New Comment">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\elshafey\resources\views/comments/create.blade.php ENDPATH**/ ?>