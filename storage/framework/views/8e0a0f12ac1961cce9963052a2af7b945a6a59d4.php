...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 m-auto">
            <form enctype="multipart/form-data" method="post" action="<?php echo e(route('products.saveedit')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <label >Price</label>
                <input type="double" name="price" class="form-control mb-3" value="<?php echo e($item->price); ?>">    
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="int" name="quantity" class="form-control mb-3" value="<?php echo e($item->quantity); ?>">    
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\elshafey\resources\views/products/edit.blade.php ENDPATH**/ ?>