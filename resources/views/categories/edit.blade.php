...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 m-auto">
            <form enctype="multipart/form-data" method="POST" action="{{route('categories.saveedit')}}">
                @csrf
                ...
                <input class="form-control mb-4" type="text" name="parent_id" value="{{$item->parent_id}}">
