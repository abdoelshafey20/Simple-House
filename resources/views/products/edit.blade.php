...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 m-auto">
            <form enctype="multipart/form-data" method="post" action="{{route('products.saveedit')}}">
                @csrf
                ...
                <label >Price</label>
                <input type="double" name="price" class="form-control mb-3" value="{{$item->price}}">    
                ...
                <input type="int" name="quantity" class="form-control mb-3" value="{{$item->quantity}}">    
